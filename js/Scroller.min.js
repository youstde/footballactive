        ...
        core.effect.Animate = {
            requestAnimationFrame: function() {
                var n = e.requestAnimationFrame || e.webkitRequestAnimationFrame || e.mozRequestAnimationFrame || e.oRequestAnimationFrame
                    , t = !!n;
                if (n && !/requestAnimationFrame\(\)\s*\{\s*\[native code\]\s*\}/i.test(n.toString()) && (t = !1),
                        t)
                    return function(e, t) {
                        n(e, t)
                    }
            ...
            start: function(e, o, u, f, c, m) {
                ...
                var d = function(i) {
                    ...
                    if (!a[q] || o && !o(q))
                        return a[q] = null,
                            void (u && u(t - A / ((w - l) / r), q, !1));
                    if (F)
                        for (var h = Math.round((w - s) / (r / t)) - 1, D = 0; D < Math.min(h, 4); D++)
                            d(!0),
                                A++;
                    f && (v = (w - l) / f,
                    v > 1 && (v = 1));
                    var R = c ? c(v) : v;
                    e(R, w, F) !== !1 && 1 !== v || !F ? F && (s = w,
                        core.effect.Animate.requestAnimationFrame(d, m)) : (a[q] = null,
                    u && u(t - A / ((w - l) / r), q, 1 === v || null == f))
                };
                return a[q] = !0,
                    core.effect.Animate.requestAnimationFrame(d, m),
                    q
            }
        }
}(this);
